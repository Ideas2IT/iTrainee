...
namespace iTrainee.Controllers
{
    ...
    public class HomeController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public IActionResult Login(string UserName, string Password)
        {
            ...
            var user = (User)HttpClientHelper.ExecuteGetApiMethod<User>(baseUrl, "/User/GetUserByUserName?", "UserName=" + UserName + "&Password=" + Password, Convert.ToString(TempData["UserToken"]));
